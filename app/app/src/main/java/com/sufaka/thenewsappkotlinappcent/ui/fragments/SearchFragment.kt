...
import com.sufaka.thenewsappkotlinappcent.databinding.FragmentSearchBinding
...
import com.sufaka.thenewsappkotlinappcent.util.Constants.Companion.SEARCH_NEWS_TIME_DELAY
...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(R.id.action_searchFragment_to_contentFragment, bundle)
        }
